class Game {
  ...
  preload() {
    ...
    this.player1Img = loadImage("assets/Putin1.png");
  ...
  drawGame() {
    ...
    let distance = dist(
      this.player1.x + this.player1.image.width / 2,
      this.player1.y + this.player1.image.height / 2,
      this.player2.x + this.player2.image.width / 2,
      this.player2.y + this.player2.image.height / 2
    );
